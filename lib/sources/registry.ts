...
const hillsboroughSiteDev = arcgis({
  descriptor: {
    ...
    stage: "entitlement",
    capabilities: caps({ owner: true, latLng: true }),
    notes: "Site plans upstream of the building permit. Carries a direct developer email or phone on ~97% of in-review projects, plus acreage.",
  },
  ...
  fields: {
    ...
    // The developer's own contact, filed with the application. 581 of 600
    // in-review projects carry an email or phone - the only pre-permit source
    // found that hands over a direct contact.
    owner_first_name: "ContactFirst",
    owner_last_name: "ContactLast",
